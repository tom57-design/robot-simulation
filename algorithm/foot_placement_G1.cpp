...
void FootPlacement_G1::dataBusRead(DataBus &robotState) {
...
void FootPlacement_G1::dataBusWrite(DataBus &robotState) {
...
void FootPlacement_G1::getSwingPos() {
    ...
    double yOff_L=0.01 * (-2.5); // foot-end position offset in y direction in body frame, positive for moving the leg inside
    double zOff_W=-0.035 * (3.0); // foot-end position offset in z direction in world frame
...
double FootPlacement_G1::Trajectory(double phase, double hei, double len){
    Bezier_1D Bswpid;
