...
GaitScheduler_G1::GaitScheduler_G1(double tSwingIn, double dtIn)
{
    tSwing = tSwingIn;
    dt = dtIn;
    phi = 0;
...
void GaitScheduler_G1::dataBusRead(const DataBus &robotState)
{
...
void GaitScheduler_G1::dataBusWrite(DataBus &robotState)
{
