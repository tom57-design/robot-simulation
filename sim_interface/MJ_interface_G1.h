...
public:
    ...
    //** For g1_23dof.xml **//
    const std::vector<std::string> JointName = {"left_hip_pitch_joint", "left_hip_roll_joint", "left_hip_yaw_joint",
                                                "left_knee_joint",
                                                ...
                                                "right_elbow_joint", "right_wrist_roll_joint"}; // joint name in XML file, the corresponds motors name should be M_*, ref to line 29 of MJ_Interface.cpp
    ...
    MJ_interface_G1(mjModel *mj_modelIn, mjData *mj_dataIn);
